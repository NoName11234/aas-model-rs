...
impl Operation {
    ...
    ///Returns the optional mutable input variables of the operation.
    pub fn get_mut_input_variables(&mut self) -> &mut Vec<OperationVariable> {
        &mut self.input_variables
    }
    ...
    ///Returns the mutable output variables of the operation.
    pub fn get_mut_output_variables(&mut self) -> &mut Vec<OperationVariable> {
        &mut self.output_variables
    }
    ...
    ///Returns a mutable list of variables which are input and output of the operation.
    pub fn get_mut_inoutput_variables(&mut self) -> &mut Vec<OperationVariable> {
        &mut self.inoutput_variables
    }
