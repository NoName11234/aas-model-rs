...
impl Blob {
    ///Creates a new structure representing a blob data element.
    pub fn new() -> Blob {
        Blob {
            value: Vec::new(),
            content_type: None,
    ...
    ///Sets the optional value of the blob instance.
    ///
    /// [value]: value of the blob instance
    pub fn set_value(&mut self, value: Vec<u8>) {
        self.value = value;
    }

    ///Returns the optional value of the blob instance.
    pub fn get_value(&self) -> &Vec<u8> {
        &self.value
    }

    ///Returns the mutable optional value of the blob instance.
    pub fn get_mut_value(&mut self) -> &mut Vec<u8> {
        &mut self.value
    }

    ///Sets the optional content type of the content of the blob.
    ///
    /// [content_type]: content type of the content of the blob
    pub fn set_content_type(&mut self, content_type: String) {
        self.content_type = Some(content_type);
    }

    ///Returns the optional content type of the content of the blob.
    pub fn get_content_type(&self) -> Option<&String> {
        self.content_type.as_ref()
    }
    
    ///Returns the optional mutable content type of the content of the blob.
    pub fn get_mut_content_type(&mut self) -> Option<&mut String> {
        self.content_type.as_mut()
    }
}

impl TSubmodelElement for Blob {}

impl TReferable for Blob {
...
impl THasDataSpecification for Blob {
